Template.customerRepsIndex.helpers({
  employees: function () {
...
Template.customerRepsIndex.onRendered(function(){
  ...
  Meteor.call('getAllRatings', function(err,res){
    if(err){
      ...
      var dset = {
        ...
        fillColor: "rgba(4, 122, 183,0.5)",
        strokeColor: "rgba(4, 122, 183,0.8)",
        highlightFill: "rgba(4,122, 183,0.75)",
        highlightStroke: "rgba(4,122,183,1)"
      };
      var rates = [];
      /*
